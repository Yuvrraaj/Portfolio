  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      details: "yuvrajjha1718@gmail.com",
      link: "mailto:yuvrajjha1718@gmail.com",
    },
    {
      icon: <MapPin className="h-5 w-5 text-brand-purple" />,
      title: "Location",
      details: "Vijayawada, Andhra Pradesh, India",
      link: "https://maps.google.com/?q=Vijayawada",
    },
  ];
  ...
  const socialLinks = [
    {
      ...
      name: "GitHub",
      url: "https://github.com/Yuvrraaj",
    },
    {
      icon: <Linkedin className="h-5 w-5" />,
      name: "LinkedIn",
      url: "https://linkedin.com/in/yuvrajjha17/",
    },
